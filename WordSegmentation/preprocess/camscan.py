...
class scanner(object):
    ...
    def showAll(self):
        ...
        th4 = l[8]
        dst = l[9]
        #cv2.imwrite('ims/orig.jpg', orig)
        cv2.imwrite('out1.png', gray)
        #cv2.imwrite('ims/blurred.jpg', blurred)
        #cv2.imwrite('ims/orig_edged.jpg', orig_edged)
        #cv2.imwrite('ims/image.jpg', th1)
        #cv2.imwrite('ims/th1.jpg', th2)
        #cv2.imwrite('ims/th2.jpg', th2)
        #cv2.imwrite('ims/th3.jpg', th3)
        #cv2.imwrite('ims/th4.jpg', th4)
        #cv2.imwrite('ims/dst.jpg', dst)
